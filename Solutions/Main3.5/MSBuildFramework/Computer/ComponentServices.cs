//-----------------------------------------------------------------------
// <copyright file="ComponentServices.cs">(c) FreeToDev. This source is subject to the Microsoft Permissive License. See http://www.microsoft.com/resources/sharedsource/licensingbasics/sharedsourcelicenses.mspx. All other rights reserved.</copyright>
//-----------------------------------------------------------------------
namespace MSBuild.ExtensionPack.Computer
{
    ...
    ///     <Target Name="Default">
    ///         <!--- Add a component -->
    ///         <MSBuild.ExtensionPack.Computer.ComponentServices TaskAction="AddComponent" Path="C:\EntServices.dll" ApplicationName="MyApplication" Identity="Interactive User"/>
    ///         <!-- Check it exists -->
    ...
    ///         <MSBuild.ExtensionPack.Computer.ComponentServices TaskAction="RemoveComponent" Path="C:\EntServices.dll" ApplicationName="MyApplication"/>
