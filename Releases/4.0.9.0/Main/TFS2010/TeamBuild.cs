...
namespace MSBuild.ExtensionPack.Tfs2010
{
    ...
    ///         <!-- Queue a new build -->
    ///         <MSBuild.ExtensionPack.Tfs2010.TeamBuild TaskAction="Queue" TeamFoundationServerUrl="$(TeamFoundationServerUrl)" TeamProject="$(TeamProject)" BuildDefinitionName="$(BuildDefinitionName)"/>
    ///         <!-- Retrieve Changesets associated with a given build -->
    ///         <MSBuild.ExtensionPack.Tfs2010.TeamBuild TaskAction="RelatedChangesets" TeamFoundationServerUrl="$(TeamFoundationServerUrl)" TeamProject="$(TeamProject)" BuildUri="$(BuildUri)" BuildDefinitionName="$(BuildDefinitionName)">
    ...
    ///         <MSBuild.ExtensionPack.Tfs2010.TeamBuild TaskAction="RelatedWorkItems" TeamFoundationServerUrl="$(TeamFoundationServerUrl)" TeamProject="$(TeamProject)" BuildUri="$(BuildUri)" BuildDefinitionName="$(BuildDefinitionName)">
