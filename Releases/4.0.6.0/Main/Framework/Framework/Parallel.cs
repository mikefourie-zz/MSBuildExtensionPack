...
namespace MSBuild.ExtensionPack.Framework
{
    ...
    ///         <MSBuild.ExtensionPack.Framework.Parallel TaskAction="BuildTargetSetsInParallel" Targets="@(MyTargetSets)" AdditionalProperties="SkipInitial=true"/>
    ///     </Target>
    ///     <Target Name="BuildTargetsInParallel">
    ///         <MSBuild.ExtensionPack.Framework.Parallel TaskAction="BuildTargetsInParallel" Targets="@(MyTargets)" AdditionalProperties="SkipInitial=true"/>
    ///     </Target>
    ///     <Target Name="Target1">
